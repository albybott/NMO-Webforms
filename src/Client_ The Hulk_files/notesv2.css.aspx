...
.noNotesToShow
{
	color: #9B9B9B;
	opacity: 1;
	font-size: 16px; /* _locID_css@font-size="notesWall_text_FontSize" _locComment="Font Size" */
	font-family:  Segoe\000020UI\000020SemiLight,Tahoma,sans\00002Dserif; /* _locID_css@font-family="notesWall_text_FontFamily" _locComment="Font Family" */
	font-weight: lighter;
	line-height: 24px;
	letter-spacing: 0px;
	text-align: center;
